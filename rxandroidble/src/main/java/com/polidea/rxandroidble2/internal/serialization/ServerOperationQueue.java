 ...
 * <br>
 * i.e. When dealing with a {@link android.bluetooth.BluetoothGattServer} each read and write needs
 * to be synchronized but changing connection
 * priority does not.
 * <br>
 * i.e.2 When starting to connect the {@link android.bluetooth.BluetoothGattServerCallback} the
 * Android Stack does queue direct connections internally
